...
class Training:
    ...
    def get_spent_calories(self) -> float:
        ...
        raise NotImplementedError('Переопредилите метод '
                                  'получения количества затраченных калорий '
...
class Running(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        return (mean_speed * self.weight / self.M_IN_KM * minutes)
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий."""
        speed_on_height = self.get_mean_speed()**2 // self.height
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    if workout_type in training_dictionary:
        training_name = training_dictionary[workout_type]
